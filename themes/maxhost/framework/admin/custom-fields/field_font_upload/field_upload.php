...
class Redux_Options_font_upload {
    ...
    */
    function render() {
        ...
        echo ' <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-font-upload button-secondary"' . $upload . ' rel-id="' . $this->field['id'] . '">' . __('Upload', 'maxhost') . '</a>';
        echo ' <a href="javascript:void(0);" class="redux-opts-font-upload-remove"' . $remove . ' rel-id="' . $this->field['id'] . '">' . __('Remove Upload', 'maxhost') . '</a>';
