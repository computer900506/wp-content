    ...
    <div class="container">
      <div class="col-md-6 left-padd0 m-bottom2">
        <h2 class="uppercase font-thin font-white font30 m-bottom1"><?php if ( is_front_page() ) : ?>
							<?php bloginfo('name'); ?>
						<?php elseif (maxhost_get_option('maxhost_indexpage_title') != '') : ?>
							<?php echo esc_attr( maxhost_get_option('maxhost_indexpage_title') ); ?>
						<?php else : ?>
							<?php printf( esc_html__( 'Blog Archives', 'maxhost' )); ?>
						<?php endif; ?></h2>
        <h4 class="font-grey-light font18 "><?php if ( is_front_page() ) : ?>
							<?php bloginfo('description'); ?>
						<?php elseif (maxhost_get_option('maxhost_indexpage_subtitle') != '') : ?>
							<?php echo esc_attr( maxhost_get_option('maxhost_indexpage_subtitle') ); ?>
						<?php else : ?>
