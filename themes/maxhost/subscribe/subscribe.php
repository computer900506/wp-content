...
$MailChimp = new MailChimp(maxhost_get_option('mailchimp_apikey'));

$mailchimp_result = $MailChimp->call('lists/subscribe', array(
													'id'                => maxhost_get_option('mailchimp_listid'),
...
if (isset($mailchimp_result['leid'])) {
	echo '<span style="color: #49A32B;">'.esc_html__('Thank you, a confirmation email has been sent!', 'maxhost').'</span>';
} else {
	echo '<span style="color: red;">'.esc_html__('Please try again.', 'maxhost').'</span>';
}
